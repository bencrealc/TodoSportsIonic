...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.f : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.r;
      }

      return checked ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.r : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.g;
    };
  }
  ...
  renderOnOffSwitchLabels(mode, checked) {
    ...
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      class: {
  ...
  render() {
    ...
    const {
      ...
      labelId,
      labelText
    } = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.d)(el, inputId);
    const value = this.getValue();
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.e)(true, el, name, checked ? value : '', disabled);
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      class: "toggle-icon",
      part: "track"
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "toggle-icon-wrapper"
    }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "toggle-inner",
      part: "handle"
    }, enableOnOffLabels && mode === 'md' && this.renderOnOffSwitchLabels(mode, checked)))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
