...
const Reorder = class {
  ...
  render() {
    ...
    const reorderIcon = mode === 'ios' ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.j : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_2__.k;
...
const ReorderGroup = class {
  ...
  connectedCallback() {
    ...
    return (0,c_Users_Benjamin_Desktop_TodoSportsIonic_ionic4j_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_4__.f)(_this.el);

      if (contentEl) {
        _this.scrollEl = yield (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
      }
