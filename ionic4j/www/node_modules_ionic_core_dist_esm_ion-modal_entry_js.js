...
/* harmony import */ var _index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-3413f7be.js */ 27288);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,c_Users_Benjamin_Desktop_TodoSportsIonic_ionic4j_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const getScrollY = () => {
    if (contentEl && (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const canStart = detail => {
    ...
    contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.f)(target);
    ...
    if (contentEl) {
       ...
       * asynchronous.
       */
      if ((0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
  ...
  const onEnd = detail => {
    ...
    if (contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialScrollY);
    }
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    const contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.a)(el);

    if (!contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.p)(el);
      return;
    }
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,c_Users_Benjamin_Desktop_TodoSportsIonic_ionic4j_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  render() {
    ...
    }, showHandle && (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      class: "modal-handle",
