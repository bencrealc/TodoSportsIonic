...
const Range = class {
  constructor(hostRef) {
    ...
    this.setupGesture = /*#__PURE__*/(0,c_Users_Benjamin_Desktop_TodoSportsIonic_ionic4j_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    this.contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialContentScrollY);
    }
