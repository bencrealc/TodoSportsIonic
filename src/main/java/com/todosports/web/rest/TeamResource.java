...
/**
 * REST controller for managing {@link com.todosports.domain.Team}.
 */
@RestController
@RequestMapping("/api")
public class TeamResource {
    ...
    public Mono<ResponseEntity<Team>> partialUpdateTeam(
        ...
        return teamRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Team> result = teamService.partialUpdate(team);
     ...
     */
    @GetMapping("/teams")
    public Mono<List<Team>> getAllTeams(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
     ...
     */
    @GetMapping(value = "/teams", produces = MediaType.APPLICATION_NDJSON_VALUE)
